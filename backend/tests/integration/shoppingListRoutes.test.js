...
describe('Shopping List Routes', () => {
  ...
  // Return a 500 status for server errors when getting shopping list items
  ...
  // Return a 404 status if the shopping list item to delete is not found
  ...
  // Create a new shopping list item with valid data
  ...
  // Return a 500 status for server errors when creating a new shopping list item
